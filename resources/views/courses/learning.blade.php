...
class="learning-page bg-gray-50 min-h-screen">
    ...
    <aside :class="{'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen}" 
        ...
        <div class="flex-shrink-0 px-6 py-4 border-b border-gray-100">
            <a href="{{ route('dashboard') }}" class="inline-flex items-center text-gray-600 hover:text-mountain-meadow-600 transition-colors text-sm font-medium cursor-pointer">
                    ...
                    <button type="button" 
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-xs text-gray-500 mt-0.5">{{ $sectionContentCounts[$section->id] ?? 0 }} lessons</p>
                            </div>
                        </div>
            ...
            <div class="main-content-wrapper">
                <div class="content-inner">
                    <div class="flex items-center justify-between">
                        ...
                        <button @click="sidebarOpen = true" class="lg:hidden p-2 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-colors cursor-pointer">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex items-center space-x-1">
                                ...
                                <a href="{{ route('dashboard.course.learning', [
                                   ...
                                   class="p-2 rounded-lg text-gray-400 hover:text-mountain-meadow-600 hover:bg-mountain-meadow-50 transition-colors cursor-pointer" 
                    ...
                    <div class="px-6 sm:px-8 lg:px-10 py-8 lg:py-12">
                        ...
                        <div class="flex flex-col sm:flex-row items-stretch gap-4 mb-8">
                            ...
                            <a href="{{ route('dashboard.course.learning', [
                               ...
                               class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-mountain-meadow-600 to-mountain-meadow-700 text-white text-sm font-medium rounded-lg hover:from-mountain-meadow-700 hover:to-mountain-meadow-800 transition-all duration-200 cursor-pointer">
                            ...
                            <a href="{{ route('dashboard.course.learning.finished', $course->slug) }}" 
                               class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white text-sm font-medium rounded-lg hover:from-green-700 hover:to-green-800 transition-all duration-200 cursor-pointer">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                        ...
                        <div class="flex flex-col sm:flex-row items-center justify-between gap-6 pt-8 border-t border-gray-200">
                            ...
                            <div class="flex-1">
                                ...
                                <a href="{{ route('dashboard.course.learning', [
                                   ...
                                   class="group inline-flex items-center text-sm font-medium text-gray-600 hover:text-mountain-meadow-600 transition-colors cursor-pointer">
