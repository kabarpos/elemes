...
@section('title', 'Course Catalog - ' . \App\Helpers\WebsiteSettingHelper::get('site_name', 'LMS Platform'))
...
@section('content')
    ...
    {{-- Featured Courses dihalaman catalog dihilangkan agar /courses hanya menampilkan All Courses --}}
