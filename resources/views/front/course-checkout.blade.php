                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="text-center p-4 bg-gray-50 rounded-lg">
                                    <div class="text-2xl font-bold text-mountain-meadow-600">{{ $totalLessons }}</div>
                                    <div class="text-sm text-gray-600">Total Lessons</div>
                                </div>
                                <div class="text-center p-4 bg-gray-50 rounded-lg">
                                    <div class="text-2xl font-bold text-mountain-meadow-600">{{ $studentsCount }}</div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                        <form id="checkout-details" class="space-y-6">
                            ...
                            <section class="space-y-4">
                                ...
                                <div class="mt-3">
                                    <div id="toggle-breakdown" class="text-sm text-mountain-meadow-700 hover:text-mountain-meadow-800 cursor-pointer select-none">
                                        Lihat rincian perhitungan
                                    </div>
                                    <div id="calculation-breakdown" class="mt-2 hidden rounded-lg border border-mountain-meadow-200 bg-mountain-meadow-50 p-3">
                                        <!-- Diisi oleh JavaScript: updateCalculationBreakdown -->
                                        <div class="text-sm text-gray-700">Memuat rincian…</div>
                                    </div>
                                </div>
                            </section>
