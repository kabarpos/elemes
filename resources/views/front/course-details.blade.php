                ...
                <div class="space-y-8">
                    ...
                    <div class="flex flex-wrap items-center gap-6">
                        ...
                        <div class="flex items-center space-x-2 bg-gray-50 px-4 py-2 rounded-lg">
                            ...
                            <span class="text-sm font-medium text-gray-700">{{ $studentsCount }} Students</span>
                        </div>
                    </div>
                                        ...
                                        <div class="bg-mountain-meadow-50 border border-mountain-meadow-200 rounded-lg p-4">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="text-right">
                                                    ...
                                                    <div class="text-sm font-medium text-gray-900">{{ $totalLessons }} lessons</div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2 space-y-12">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                        <!-- Section Header -->
                        <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 border-b border-gray-100">
                            <h2 class="text-xl sm:text-2xl font-bold text-gray-900">Course Curriculum</h2>
                            <p class="text-gray-600 mt-2 text-sm sm:text-base">Structured learning path designed by industry experts</p>
                        </div>
                                                ...
                                                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                                    <div class="flex items-center min-w-0 flex-1">
                                                        ...
                                                        <div class="text-left min-w-0 flex-1">
                                                            <h3 class="text-base sm:text-lg font-semibold text-gray-900 truncate">{{ $section->name }}</h3>
                                                                ...
                                                                @else
                                                                    ...
                                                                    <div class="flex flex-col sm:flex-row sm:items-center p-3 sm:p-4 rounded-lg border border-gray-100 {{ $isLocked ? 'bg-gray-50' : 'hover:border-mountain-meadow-200 hover:bg-mountain-meadow-50' }} transition-all duration-200 gap-3 sm:gap-0">
                                                                        <div class="flex items-center flex-1 min-w-0">
                                                                            ...
                                                                            <!-- Lesson Info -->
                                                                            <div class="flex-1 min-w-0">
                                                                                <h4 class="font-medium {{ $isLocked ? 'text-gray-500' : 'text-gray-900' }} text-sm sm:text-base truncate">{{ $content->name }}</h4>
                    ...
                    <div class="sticky top-8 space-y-6">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            ...
                            <div class="space-y-3">
                                @auth
                                    <a href="{{ route('dashboard.course.join', $course->slug) }}" 
                                       class="w-full flex items-center justify-center px-4 py-3 bg-mountain-meadow-600 text-white font-medium rounded-lg hover:bg-mountain-meadow-700 transition-colors duration-200 cursor-pointer">
                                ...
                                <div class="relative" x-data="{ shareOpen: false }">
                                    <button @click="shareOpen = !shareOpen" class="w-full flex items-center justify-center px-4 py-3 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-colors duration-200 cursor-pointer">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div x-show="shareOpen" 
                                        ...
                                        <div class="py-2">
                                            <!-- WhatsApp -->
                                            <button onclick="shareToWhatsApp()" class="w-full flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-200 cursor-pointer">
                                            ...
                                            <!-- Telegram -->
                                            <button onclick="shareToTelegram()" class="w-full flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-200 cursor-pointer">
                                            ...
                                            <!-- Facebook -->
                                            <button onclick="shareToFacebook()" class="w-full flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-200 cursor-pointer">
                                            ...
                                            <!-- X (Twitter) -->
                                            <button onclick="shareToX()" class="w-full flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-200 cursor-pointer">
                                            ...
                                            <!-- Threads -->
                                            <button onclick="shareToThreads()" class="w-full flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-200 cursor-pointer">
                                                <svg class="w-5 h-5 mr-3 text-gray-900" fill="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <!-- Copy Link -->
                                            <button onclick="copyLink()" class="w-full flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-200 cursor-pointer border-t border-gray-100">
