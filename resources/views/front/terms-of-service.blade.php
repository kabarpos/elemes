...
@section('content')
    ...
    <section class="hero-gradient py-16 lg:py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <!-- Trust Badge -->
            <div class="inline-flex items-center space-x-2 px-4 py-2 bg-mountain-meadow-50 text-mountain-meadow-700 rounded-full text-sm font-semibold mb-6">
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                </svg>
                <span>KEBIJAKAN & PERATURAN</span>
            </div>
            ...
            <div class="prose prose-lg max-w-none">
                ...
                <div class="bg-gray-50 rounded-xl p-8 mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                        <div class="w-8 h-8 bg-mountain-meadow-100 rounded-lg flex items-center justify-center mr-3">
                ...
                <!-- Contact Information -->
                <div class="bg-mountain-meadow-50 border border-mountain-meadow-200 rounded-xl p-8">
                    <h2 class="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                        <div class="w-8 h-8 bg-mountain-meadow-600 rounded-lg flex items-center justify-center mr-3">
                    ...
                    <div class="space-y-2 text-gray-700 text-line-height-relaxed">
                        <p><strong>Email:</strong>
                            <a
                                href="{{ $emailHref }}"
                                class="text-mountain-meadow-700 hover:text-mountain-meadow-900 underline cursor-pointer"
                            >
                                {{ $email }}
                            </a>
                        </p>
