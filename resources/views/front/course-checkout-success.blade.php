    ...
    <main class="bg-gray-50 min-h-screen py-16">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                <!-- Success Header -->
                <div class="bg-gradient-to-r from-mountain-meadow-500 to-mountain-meadow-600 px-8 py-12 text-center">
                    <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6">
                        <svg class="w-10 h-10 text-mountain-meadow-500" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="p-8">
                    <div class="flex items-center space-x-6 p-6 bg-gray-50 rounded-xl border border-gray-200">
                            ...
                            <div class="w-24 h-24 rounded-lg overflow-hidden bg-gray-100">
                                ...
                                @else
                                    <div class="w-full h-full flex items-center justify-center bg-mountain-meadow-100">
                                        <span class="text-mountain-meadow-600 font-bold text-lg">{{ substr($course->name, 0, 2) }}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="space-y-2">
                                @if($course->category)
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-mountain-meadow-100 text-mountain-meadow-700">
                    ...
                    <div class="mt-8 space-y-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 pt-6">
                            <a href="{{ route('dashboard.course.join', $course->slug) }}" 
                               class="flex-1 inline-flex items-center justify-center px-6 py-3 bg-mountain-meadow-600 text-white font-semibold rounded-lg hover:bg-mountain-meadow-700 transition-colors duration-200 shadow-lg hover:shadow-xl cursor-pointer">
                        ...
                        <!-- Additional Info -->
                        <div class="text-center mt-8 p-4 bg-mountain-meadow-50 rounded-lg border border-mountain-meadow-200">
                            <p class="text-sm text-mountain-meadow-700">
