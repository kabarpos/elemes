            ...
            <div id="rateLimitModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/40">
                <div class="w-full max-w-md rounded-2xl bg-white shadow-xl">
                    ...
                    <div class="px-6 pb-6 mt-4 flex gap-3">
                        ...
                        <a href="{{ route('password.reset.options') }}" class="flex-1 rounded-full border border-LMS-green px-5 py-3 text-LMS-green font-semibold text-center cursor-pointer">Lupa Password?</a>
                    </div>
                </div>
            </div>
